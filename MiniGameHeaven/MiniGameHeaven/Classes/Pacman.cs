...
namespace MiniGameHeaven
{
    public class Pacman
    {
        ...
        private void CheckPacmanPosition()
        {
            ...
            switch (pac_man.gameboard.Matrix[yCoordinate, xCoordinate])
            {
                case 1: pac_man.food.EatFood(yCoordinate, xCoordinate); break;
                case 2: pac_man.food.EatSuperFood(yCoordinate, xCoordinate); break;
            }
        }
        ...
        private bool direction_ok(int x, int y)
        {
            ...
            if (pac_man.gameboard.Matrix[y, x] < 4) { return true; } else { return false; }
        }
